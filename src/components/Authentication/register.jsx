          ...
          <div className="bg-white shadow-lg rounded-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-secondary/60 mt-2">
                Join our community of hope givers
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 space-y-3">
                <button
                  type="button"
                  className="w-full flex items-center justify-center px-4 py-3 border border-secondary/30 rounded-lg bg-white text-secondary/70 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
